...
import {Container, CardItem, Thumbnail, Body, Button, Right} from 'native-base';
...
class Pending extends Component{
    constructor() {
        ...
        _bootstrapAsync = () =>{
            this.unsubscribe = this.ref.collection('orders').where('OrderStatus', '==', "Pending").orderBy('OrderNo', 'asc').onSnapshot(this.onCollectionUpdate) ;
          };
