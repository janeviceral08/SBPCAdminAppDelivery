...
const DataTableOR = ({ alignment, headerTitles, children, total, qty, TotalDiscount,TotalExtra,TotalDeliveryCharge,TotalSubtotal }) => {
  return (
    <View style={{flex :1}}>
                     ...
                     <Row style={{height: 20,  backgroundColor: 'gray'}}>
                          <Col key={0} style={[styles.ColStyle,{alignItems: alignment}]}>
                                  ...
                                  <Col key={5} style={[styles.ColStyle,{alignItems: alignment}]}>
                                    <Text  style={styles.textColor}>{ parseFloat(TotalDiscount)}</Text>
                                </Col>  
